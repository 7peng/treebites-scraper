...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="https://login-assets.stanford.edu/assets/favicon.ico" type="image/x-icon" />
    <link rel="shortcut icon" href="https://login-assets.stanford.edu/assets/favicon.ico" type="image/x-icon" />  
    <script src="https://login-assets.stanford.edu/assets/js/jquery-3.6.0.min.js"></script> 
    <!-- bootstrap -->
    <link type="text/css" rel="stylesheet" href="https://login-assets.stanford.edu/assets/css/bootstrap.min.css" />
    <link type="text/css" rel="stylesheet" href="https://login-assets.stanford.edu/assets/css/su-identity.css" />
    <script src="https://login-assets.stanford.edu/assets/js/login.js"></script>
    <!-- login CSS -->
    <link rel="stylesheet" type="text/css" href="https://login-assets.stanford.edu/assets/css/login.css" />
...
function isLocalStorageSupported() {
    ...
    <div id="su-wrap">
      ...
      <div id="su-content">
        ...
        <div id="brandbar">
          <div class="container">
            <a href="http://www.stanford.edu"> <img src="https://login-assets.stanford.edu/assets/images/brandbar-stanford-logo@2x.png" alt="Stanford University" width="153" height="22"> </a>
          </div>
          <!-- .container end -->
        </div>
        <!-- #brandbar end -->
        ...
        <div id="header">
          <div class="container">
            <div style="margin: 1em 10px 0 0;">
              <img alt="Stanford Login" src="https://login-assets.stanford.edu/assets/images/login-header@2x.png">
...
<form name="form1" action="/idp/profile/SAML2/Redirect/SSO?execution=e6s1" method="post">
    <input type="hidden" name="csrf_token" value="_f11d000a27240cb1bd1582903b7cd70b2279f150" />
...
Logging in lets you access other protected Stanford websites with this browser, not just the website you requested.                </p>
                ...
                <div class="settings">
                  ...
                  <p><a href="https://accounts.stanford.edu/ords/r/regapps/accounts/lost-two-step-device" class="more-link"><span class="fa fa-chevron-circle-right"></span> <span>TWO-STEP DEVICE UNAVAILABLE?</span></a></p>
                </div>
              </div>
            </div>
            <div class="row">
    ...
    <div id="global-footer">
      <div class="container">
        <div class="row">
          <div class="col-xs-6 col-sm-2" id="bottom-logo"> <a href="https://www.stanford.edu/"> <img width="105" height="49" alt="Stanford University" src="https://login-assets.stanford.edu/assets/images/footer-stanford-logo@2x.png"> </a> </div>
          <!-- #bottom-logo end -->
